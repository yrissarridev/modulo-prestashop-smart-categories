          ...
          <div class="sc-form-grid">
            ...
            <div class="sc-form-group">
              ...
              <div class="sc-select-with-action">
                <input type="text" id="sc-category-search" class="form-control" placeholder="Buscar categoría por nombre o ID..." style="margin-bottom:8px;">
<select id="ruleCategory" name="id_category" class="sc-select" required class="sc-select2-category">
